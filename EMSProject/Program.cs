...
namespace EMSProject
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            employee.Add(new Employee(1, "Sudhakaran1", "asdasdas", "dasdfdwe", 121, "ore"));
            employee.Add(new Employee(2, "Sudhakaran2", "asdasdas", "dasdfdwe", 121, "ore"));
            employee.Add(new Employee(3, "Sudhakaran3", "asdasdas", "dasdfdwe", 121, "ore"));
            employee.Add(new Employee(4, "Sudhakaran4", "asdasdas", "dasdfdwe", 121, "ore"));
            employee.Add(new Employee(5, "Sudhakaran4", "asdasdas", "dasdfdwe", 121, "ore"));
